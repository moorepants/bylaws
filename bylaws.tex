...
and shall be located in Yolo County, California.
\subsection{Other Offices}
\label{sec:otherOffices}
The Ministry may at any time establish branch or subordinate offices at any
place or places where the Corporation is qualified to transact business.
\section{PURPOSES}
\label{sec:purposes}
...
Corporation Law of California (``\defn{California Nonprofit Corporation Law}'')
for educational purposes.
\subsection{Specific Purpose}
\label{sec:specificPurpose}
Without limiting the generality of the foregoing general purpose, the specific
purposes of this Corporation are to:
\begin{itemize}
    \item[(1)] provide the community a low-cost resource that provides the
        knowledge and tools necessary to maintain, repair and safely operate
        their various forms of human-powered transportation,
    \item[(2)] promote personal and community empowerment through education,
        and
...
to as a ``\defn{Minister}'', and the active voting membership shall be referred
to collectively as ``\defn{The Ministry}.'' To become a Minister, a person must
be inducted by consensus of the Ministry. A Minister lapses to inactive
non-voting status if the person:
\begin{itemize}
    \item[(1)] has not attended and participated in Ministry meetings for six
        consecutive months; or
    \item[(2)] declares to the Ministry their intention to switch to such
        status
\end{itemize}
...
revoked by consensus of the Ministry. See also: Section~\ref{sec:removal},
regarding removal of a Minister.
\subsection{Voting Procedures}
\label{sec:votingProcedures}
The Corporation shall conduct business by consensus, where ``\defn{Consensus}''
is defined as unanimous agreement of the Ministry present and voting on such
matters, notwithstanding abstaining votes.

For any decision that is stalled by opposition of a minority of the Ministry, a
committee chaired by those in opposition shall be charged with the
responsibility of assessing the conflict and developing an alternative course
of action that better serves the mission of the Corporation. If this is not
done within a reasonable time, a two-thirds majority vote of the Ministry shall
...
\label{sec:number}
The authorized number of Directors of the Corporation (``\defn{Directors}'')
shall be three. The number may be changed by amendment of this bylaw, or by
repeal of this bylaw and adoption of a new bylaw, as provided in these bylaws,
provided that such amendment or adoption does not conflict with Section 212(a)
of the California Corporations Code, governing the required number of
Directors, or such other provision or provisions of law in effect at the time
of the amendment or adoption.
...
(the ``\defn{Articles of Incorporation}''), California Nonprofit Corporation
Law and any other applicable laws, the business and affairs of the Corporation
shall be managed, and all corporate powers shall be exercised, by or under the
Board of Directors (``\defn{The Board}''), which shall take its direction from
the Ministry.  The Ministry may delegate the management of the activities of
the Corporation to any person or persons, management company or committee
...
direction of the Board, as required by Section 5210 of the California
Corporations Code.  Any actions taken or powers exercised by the Board on
behalf of the Corporation must be ratified and approved by a consensus vote of
the Ministry.
...
If there is a vacancy on the Board, including a vacancy created by the removal
or resignation of a Director, the Ministry may fill such vacancy by electing an
additional Director as soon as practicable after the vacancy occurs.  If the
number of Directors then in office is less than a quorum, additional directors
may be elected to fill such vacancies by consensus of the Ministry at a meeting
held according to notice or written consents complying with section 5211 of the
...
Bylaws as the ``\defn{Semi-annual Meeting}.'' Other regular meetings of the
Ministry may be held at such time and place as the Ministry may fix from time
...
any Minister, as provided in Section~\ref{sec:noticeMeetings} on the Notice of
Meetings.
...
in these Bylaws for regular appointments to that office, provided that such
vacancies shall be filled as they occur and not on a semi-annual basis. In the
event of a vacancy, a new officer shall be elected at a special meeting held
within ten days or at the next regular meeting, whichever comes first.
\subsection{Responsibilities of Officers}
\label{sec:responsibilitiesOfficers}
\subsubsection{President of the Board}
\label{sec:president}
The President (the ``\defn{President}'') shall be a member of the Board of
Directors and shall be responsible for making sure there is a volunteer
Minister or volunteer Ministers to preside over and to take notes at each
meeting. This minister or these ministers will be known as the meeting
facilitator(s) and the note-taker, respectively. The facilitator(s) may be any
Minister, including the officers.
\subsubsection{Secretary}
\label{sec:secretary}
The secretary of the Corporation (the ``\defn{Secretary}'') shall attend to the
following:
\paragraph{Bylaws}
The Secretary shall certify and keep or cause to be kept at the principal
office of the Corporation the original or a copy of these Bylaws as amended to
date.
...
Upon request, the Secretary shall exhibit or cause to be exhibited at all
reasonable times to any Minister, or to his or her agent or attorney, these
Bylaws and the minute book.
